...
class GetCharactersCharacterIdMedals200Ok implements ModelInterface, ArrayAccess {
	...
	protected static $swaggerTypes = [
		...
		'reason' => 'string',
		'status' => 'string',
		'graphics' => '\WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetCharactersCharacterIdMedalsGraphic[]'
	];
	...
	public function listInvalidProperties() {
		...
		if(!in_array($this->container['status'], $allowedValues)) {
			$invalidProperties[] = sprintf(
				"invalid value for 'status', must be one of '%s'", implode("', '", $allowedValues)
			);
		}
	 ...
	 * Gets graphics
	 *
	 * @return \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetCharactersCharacterIdMedalsGraphic[]
	 */
	 ...
	 * Sets graphics
	 *
	 * @param \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetCharactersCharacterIdMedalsGraphic[] $graphics graphics array
	 *
	 * @return $this
	 */
