	...
	public function listInvalidProperties() {
		...
		if(!in_array($this->container['location_flag'], $allowedValues)) {
			$invalidProperties[] = sprintf(
				"invalid value for 'location_flag', must be one of '%s'", implode("', '", $allowedValues)
			);
		}
		...
		if(!in_array($this->container['action'], $allowedValues)) {
			$invalidProperties[] = sprintf(
				"invalid value for 'action', must be one of '%s'", implode("', '", $allowedValues)
			);
		}
		...
		if(!in_array($this->container['password_type'], $allowedValues)) {
			$invalidProperties[] = sprintf(
				"invalid value for 'password_type', must be one of '%s'", implode("', '", $allowedValues)
			);
		}
