...
class GetSovereigntyCampaigns200Ok implements ModelInterface, ArrayAccess {
	...
	protected static $swaggerTypes = [
		...
		'participants' => '\WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetSovereigntyCampaignsParticipant[]'
	];
	...
	public function listInvalidProperties() {
		...
		if(!in_array($this->container['event_type'], $allowedValues)) {
			$invalidProperties[] = sprintf(
				"invalid value for 'event_type', must be one of '%s'", implode("', '", $allowedValues)
			);
		}
	 ...
	 * Gets participants
	 *
	 * @return \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetSovereigntyCampaignsParticipant[]
	 */
	 ...
	 * Sets participants
	 *
	 * @param \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetSovereigntyCampaignsParticipant[] $participants Alliance participating and their respective scores, only present in Freeport Events.
	 *
	 * @return $this
	 */
