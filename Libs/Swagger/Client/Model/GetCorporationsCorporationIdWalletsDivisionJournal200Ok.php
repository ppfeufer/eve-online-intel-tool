...
class GetCorporationsCorporationIdWalletsDivisionJournal200Ok implements ModelInterface, ArrayAccess {
	...
	protected static $swaggerTypes = [
		...
		'tax_receiver_id' => 'int',
		'tax' => 'double',
		'extra_info' => '\WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetCorporationsCorporationIdWalletsDivisionJournalExtraInfo'
	];
	...
	public function listInvalidProperties() {
		...
		if(!in_array($this->container['ref_type'], $allowedValues)) {
			$invalidProperties[] = sprintf(
				"invalid value for 'ref_type', must be one of '%s'", implode("', '", $allowedValues)
			);
		}
		...
		if(!in_array($this->container['first_party_type'], $allowedValues)) {
			$invalidProperties[] = sprintf(
				"invalid value for 'first_party_type', must be one of '%s'", implode("', '", $allowedValues)
			);
		}
		...
		if(!in_array($this->container['second_party_type'], $allowedValues)) {
			$invalidProperties[] = sprintf(
				"invalid value for 'second_party_type', must be one of '%s'", implode("', '", $allowedValues)
			);
		}
	 ...
	 * Gets extra_info
	 *
	 * @return \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetCorporationsCorporationIdWalletsDivisionJournalExtraInfo
	 */
	 ...
	 * Sets extra_info
	 *
	 * @param \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetCorporationsCorporationIdWalletsDivisionJournalExtraInfo $extra_info extra_info
	 *
	 * @return $this
	 */
