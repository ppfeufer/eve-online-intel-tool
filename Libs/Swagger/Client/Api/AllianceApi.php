...
class AllianceApi {
	...
	public function getAlliancesWithHttpInfo($datasource = 'tranquility', $user_agent = null, $x_user_agent = null) {
		...
		try {
			...
			switch($e->getCode()) {
				...
				case 500:
					$data = ObjectSerializer::deserialize($e->getResponseBody(), '\WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\InternalServerError', $e->getResponseHeaders());
					$e->setResponseObject($data);
					break;
			}
	 ...
	 * @throws \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\ApiException on non-2xx response
	 * @throws \InvalidArgumentException
	 * @return \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetAlliancesAllianceIdOk
	 */
	 ...
	 * @throws \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\ApiException on non-2xx response
	 * @throws \InvalidArgumentException
	 * @return array of \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetAlliancesAllianceIdOk, HTTP status code, HTTP response headers (array of strings)
	 */
			...
			switch($e->getCode()) {
				case 200:
					$data = ObjectSerializer::deserialize(
						$e->getResponseBody(), '\WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetAlliancesAllianceIdOk', $e->getResponseHeaders()
					);
					$e->setResponseObject($data);
					break;
				...
				case 404:
					$data = ObjectSerializer::deserialize(
						$e->getResponseBody(), '\WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetAlliancesAllianceIdNotFound', $e->getResponseHeaders()
					);
					$e->setResponseObject($data);
					break;
	...
	protected function getAlliancesAllianceIdRequest($alliance_id, $datasource = 'tranquility', $user_agent = null, $x_user_agent = null) {
		...
		$resourcePath = '/latest/alliances/{alliance_id}/';
		$formParams = [];
		$queryParams = [];
		$headerParams = [];
		$httpBody = '';
	...
	protected function getAlliancesAllianceIdCorporationsRequest($alliance_id, $datasource = 'tranquility', $user_agent = null, $x_user_agent = null) {
		...
		$resourcePath = '/latest/alliances/{alliance_id}/corporations/';
		$formParams = [];
		$queryParams = [];
		$headerParams = [];
		$httpBody = '';
	 ...
	 * @throws \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\ApiException on non-2xx response
	 * @throws \InvalidArgumentException
	 * @return \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetAlliancesAllianceIdIconsOk
	 */
	 ...
	 * @throws \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\ApiException on non-2xx response
	 * @throws \InvalidArgumentException
	 * @return array of \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetAlliancesAllianceIdIconsOk, HTTP status code, HTTP response headers (array of strings)
	 */
	public function getAlliancesAllianceIdIconsWithHttpInfo($alliance_id, $datasource = 'tranquility', $user_agent = null, $x_user_agent = null) {
		...
		try {
			...
			switch($e->getCode()) {
				case 200:
					$data = ObjectSerializer::deserialize(
						$e->getResponseBody(), '\WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetAlliancesAllianceIdIconsOk', $e->getResponseHeaders()
					);
					$e->setResponseObject($data);
					break;
				...
				case 404:
					$data = ObjectSerializer::deserialize(
						$e->getResponseBody(), '\WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetAlliancesAllianceIdIconsNotFound', $e->getResponseHeaders()
					);
					$e->setResponseObject($data);
					break;
	...
	protected function getAlliancesAllianceIdIconsRequest($alliance_id, $datasource = 'tranquility', $user_agent = null, $x_user_agent = null) {
		...
		$resourcePath = '/latest/alliances/{alliance_id}/icons/';
		$formParams = [];
		$queryParams = [];
		$headerParams = [];
		$httpBody = '';
	 ...
	 * @throws \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\ApiException on non-2xx response
	 * @throws \InvalidArgumentException
	 * @return \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetAlliancesNames200Ok[]
	 */
	 ...
	 * @throws \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\ApiException on non-2xx response
	 * @throws \InvalidArgumentException
	 * @return array of \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetAlliancesNames200Ok[], HTTP status code, HTTP response headers (array of strings)
	 */
	public function getAlliancesNamesWithHttpInfo($alliance_ids, $datasource = 'tranquility', $user_agent = null, $x_user_agent = null) {
		...
		try {
			...
			switch($e->getCode()) {
				case 200:
					$data = ObjectSerializer::deserialize(
						$e->getResponseBody(), '\WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetAlliancesNames200Ok[]', $e->getResponseHeaders()
					);
					$e->setResponseObject($data);
					break;
	...
	protected function getAlliancesNamesRequest($alliance_ids, $datasource = 'tranquility', $user_agent = null, $x_user_agent = null) {
		...
		$resourcePath = '/latest/alliances/names/';
		$formParams = [];
		$queryParams = [];
		$headerParams = [];
		$httpBody = '';
