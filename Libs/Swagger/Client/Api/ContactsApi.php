...
class ContactsApi {
	 ...
	 * @throws \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\ApiException on non-2xx response
	 * @throws \InvalidArgumentException
	 * @return \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetAlliancesAllianceIdContacts200Ok[]
	 */
	 ...
	 * @throws \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\ApiException on non-2xx response
	 * @throws \InvalidArgumentException
	 * @return array of \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetAlliancesAllianceIdContacts200Ok[], HTTP status code, HTTP response headers (array of strings)
	 */
	public function getAlliancesAllianceIdContactsWithHttpInfo($alliance_id, $datasource = 'tranquility', $page = '1', $token = null, $user_agent = null, $x_user_agent = null) {
		$returnType = '\WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetAlliancesAllianceIdContacts200Ok[]';
		...
		try {
			...
			switch($e->getCode()) {
				case 200:
					$data = ObjectSerializer::deserialize(
							$e->getResponseBody(), '\WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetAlliancesAllianceIdContacts200Ok[]', $e->getResponseHeaders()
					);
					$e->setResponseObject($data);
					break;
				case 403:
	...
	protected function getAlliancesAllianceIdContactsRequest($alliance_id, $datasource = 'tranquility', $page = '1', $token = null, $user_agent = null, $x_user_agent = null) {
		...
		if($alliance_id !== null) {
			$resourcePath = str_replace(
				'{' . 'alliance_id' . '}', ObjectSerializer::toPathValue($alliance_id), $resourcePath
			);
		}
	 ...
	 * @throws \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\ApiException on non-2xx response
	 * @throws \InvalidArgumentException
	 * @return \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetCharactersCharacterIdContacts200Ok[]
	 */
	 ...
	 * @throws \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\ApiException on non-2xx response
	 * @throws \InvalidArgumentException
	 * @return array of \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetCharactersCharacterIdContacts200Ok[], HTTP status code, HTTP response headers (array of strings)
	 */
	public function getCharactersCharacterIdContactsWithHttpInfo($character_id, $datasource = 'tranquility', $page = '1', $token = null, $user_agent = null, $x_user_agent = null) {
		$returnType = '\WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetCharactersCharacterIdContacts200Ok[]';
		...
		try {
			...
			switch($e->getCode()) {
				case 200:
					$data = ObjectSerializer::deserialize(
							$e->getResponseBody(), '\WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetCharactersCharacterIdContacts200Ok[]', $e->getResponseHeaders()
					);
					$e->setResponseObject($data);
					break;
				case 403:
	 ...
	 * @throws \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\ApiException on non-2xx response
	 * @throws \InvalidArgumentException
	 * @return \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetCharactersCharacterIdContactsLabels200Ok[]
	 */
	 ...
	 * @throws \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\ApiException on non-2xx response
	 * @throws \InvalidArgumentException
	 * @return array of \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetCharactersCharacterIdContactsLabels200Ok[], HTTP status code, HTTP response headers (array of strings)
	 */
	public function getCharactersCharacterIdContactsLabelsWithHttpInfo($character_id, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null) {
		$returnType = '\WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetCharactersCharacterIdContactsLabels200Ok[]';
		...
		try {
			...
			switch($e->getCode()) {
				case 200:
					$data = ObjectSerializer::deserialize(
							$e->getResponseBody(), '\WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetCharactersCharacterIdContactsLabels200Ok[]', $e->getResponseHeaders()
					);
					$e->setResponseObject($data);
					break;
				case 403:
	 ...
	 * @throws \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\ApiException on non-2xx response
	 * @throws \InvalidArgumentException
	 * @return \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetCorporationsCorporationIdContacts200Ok[]
	 */
	 ...
	 * @throws \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\ApiException on non-2xx response
	 * @throws \InvalidArgumentException
	 * @return array of \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetCorporationsCorporationIdContacts200Ok[], HTTP status code, HTTP response headers (array of strings)
	 */
	public function getCorporationsCorporationIdContactsWithHttpInfo($corporation_id, $datasource = 'tranquility', $page = '1', $token = null, $user_agent = null, $x_user_agent = null) {
		$returnType = '\WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetCorporationsCorporationIdContacts200Ok[]';
		...
		try {
			...
			switch($e->getCode()) {
				case 200:
					$data = ObjectSerializer::deserialize(
							$e->getResponseBody(), '\WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetCorporationsCorporationIdContacts200Ok[]', $e->getResponseHeaders()
					);
					$e->setResponseObject($data);
					break;
				case 403:
