...
class UserInterfaceApi {
	...
	protected function postUiAutopilotWaypointRequest($add_to_beginning, $clear_other_waypoints, $destination_id, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null) {
		...
		$resourcePath = '/latest/ui/autopilot/waypoint/';
		$formParams = [];
		$queryParams = [];
		$headerParams = [];
		$httpBody = '';
	...
	protected function postUiOpenwindowContractRequest($contract_id, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null) {
		...
		$resourcePath = '/latest/ui/openwindow/contract/';
		$formParams = [];
		$queryParams = [];
		$headerParams = [];
		$httpBody = '';
	...
	protected function postUiOpenwindowInformationRequest($target_id, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null) {
		...
		$resourcePath = '/latest/ui/openwindow/information/';
		$formParams = [];
		$queryParams = [];
		$headerParams = [];
		$httpBody = '';
	...
	protected function postUiOpenwindowMarketdetailsRequest($type_id, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null) {
		...
		$resourcePath = '/latest/ui/openwindow/marketdetails/';
		$formParams = [];
		$queryParams = [];
		$headerParams = [];
		$httpBody = '';
	 ...
	 *
	 * @param  \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\PostUiOpenwindowNewmailNewMail $new_mail The details of mail to create (required)
	 * @param  string $datasource The server name you would like data from (optional, default to tranquility)
	 * @param  string $token Access token to use if unable to set a header (optional)
	 * @param  string $user_agent Client identifier, takes precedence over headers (optional)
	 * @param  string $x_user_agent Client identifier, takes precedence over User-Agent (optional)
	...
	public function postUiOpenwindowNewmailWithHttpInfo($new_mail, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null) {
		...
		try {
			...
			switch($e->getCode()) {
				...
				case 422:
					$data = ObjectSerializer::deserialize(
							$e->getResponseBody(), '\WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\PostUiOpenwindowNewmailUnprocessableEntity', $e->getResponseHeaders()
					);
					$e->setResponseObject($data);
					break;
				case 500:
	...
	protected function postUiOpenwindowNewmailRequest($new_mail, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null) {
		...
		$resourcePath = '/latest/ui/openwindow/newmail/';
		$formParams = [];
		$queryParams = [];
		$headerParams = [];
		$httpBody = '';
