...
class FittingsApi {
	...
	protected function deleteCharactersCharacterIdFittingsFittingIdRequest($character_id, $fitting_id, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null) {
		...
		if($fitting_id !== null) {
			$resourcePath = str_replace(
				'{' . 'fitting_id' . '}', ObjectSerializer::toPathValue($fitting_id), $resourcePath
			);
		}
	 ...
	 * @throws \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\ApiException on non-2xx response
	 * @throws \InvalidArgumentException
	 * @return \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetCharactersCharacterIdFittings200Ok[]
	 */
	 ...
	 * @throws \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\ApiException on non-2xx response
	 * @throws \InvalidArgumentException
	 * @return array of \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetCharactersCharacterIdFittings200Ok[], HTTP status code, HTTP response headers (array of strings)
	 */
	public function getCharactersCharacterIdFittingsWithHttpInfo($character_id, $datasource = 'tranquility', $token = null, $user_agent = null, $x_user_agent = null) {
		$returnType = '\WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetCharactersCharacterIdFittings200Ok[]';
		...
		try {
			...
			switch($e->getCode()) {
				case 200:
					$data = ObjectSerializer::deserialize(
							$e->getResponseBody(), '\WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetCharactersCharacterIdFittings200Ok[]', $e->getResponseHeaders()
					);
					$e->setResponseObject($data);
					break;
				case 403:
	 ...
	 * @param  int $character_id An EVE character ID (required)
	 * @param  string $datasource The server name you would like data from (optional, default to tranquility)
	 * @param  \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\PostCharactersCharacterIdFittingsFitting $fitting Details about the new fitting (optional)
	 * @param  string $token Access token to use if unable to set a header (optional)
	 * @param  string $user_agent Client identifier, takes precedence over headers (optional)
	 * @param  string $x_user_agent Client identifier, takes precedence over User-Agent (optional)
	 *
	 * @throws \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\ApiException on non-2xx response
	 * @throws \InvalidArgumentException
	 * @return \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\PostCharactersCharacterIdFittingsCreated
	 */
	 ...
	 * @throws \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\ApiException on non-2xx response
	 * @throws \InvalidArgumentException
	 * @return array of \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\PostCharactersCharacterIdFittingsCreated, HTTP status code, HTTP response headers (array of strings)
	 */
	public function postCharactersCharacterIdFittingsWithHttpInfo($character_id, $datasource = 'tranquility', $fitting = null, $token = null, $user_agent = null, $x_user_agent = null) {
		$returnType = '\WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\PostCharactersCharacterIdFittingsCreated';
		...
		try {
			...
			switch($e->getCode()) {
				case 201:
					$data = ObjectSerializer::deserialize(
							$e->getResponseBody(), '\WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\PostCharactersCharacterIdFittingsCreated', $e->getResponseHeaders()
					);
					$e->setResponseObject($data);
					break;
				case 403:
