...
class IncursionsApi {
	 ...
	 * @return \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetIncursions200Ok[]
	 */
	 ...
	 * @throws \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\ApiException on non-2xx response
	 * @throws \InvalidArgumentException
	 * @return array of \WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetIncursions200Ok[], HTTP status code, HTTP response headers (array of strings)
	 */
	public function getIncursionsWithHttpInfo($datasource = 'tranquility', $user_agent = null, $x_user_agent = null) {
		$returnType = '\WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetIncursions200Ok[]';
			...
			switch($e->getCode()) {
				case 200:
					$data = ObjectSerializer::deserialize(
							$e->getResponseBody(), '\WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetIncursions200Ok[]', $e->getResponseHeaders()
					);
