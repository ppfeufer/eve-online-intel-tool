...
class AssetsApi {
			...
			switch($e->getCode()) {
				case 200:
					$data = ObjectSerializer::deserialize(
						$e->getResponseBody(), '\WordPress\Plugin\EveOnlineIntelTool\Libs\Swagger\Client\Model\GetCharactersCharacterIdAssets200Ok[]', $e->getResponseHeaders()
					);
	...
	protected function getCharactersCharacterIdAssetsRequest($character_id, $datasource = 'tranquility', $page = '1', $token = null, $user_agent = null, $x_user_agent = null) {
		...
		$resourcePath = '/latest/characters/{character_id}/assets/';
		$formParams = [];
		$queryParams = [];
		$headerParams = [];
		$httpBody = '';
