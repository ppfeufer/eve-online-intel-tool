...
class KillmailsRepository extends \WordPress\Plugins\EveOnlineIntelTool\Libs\Esi\Swagger {
     ...
     * @return \WordPress\Plugins\EveOnlineIntelTool\Libs\Esi\Model\Killmails\KillmailsKillmailId
     */
    public function killmailsKillmailIdKillmailHash($killmailID, $killmailHash) {
        ...
        return $this->map($this->callEsi(), new \WordPress\Plugins\EveOnlineIntelTool\Libs\Esi\Model\Killmails\KillmailsKillmailId);
    }
}
