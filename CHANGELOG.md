...
- Removed unused information from the fleet scan
...
- Image API end point for ships (To many end point that do the same here ...), and this time we have the right images for T2 ships :-)
