...
?>
<img class="eve-image" data-eveid="<?php echo $data['shipID']; ?>" data-shipclass="<?php echo $data['shipName']; ?>" src="<?php echo $image; ?>" alt="<?php echo $data['shipName']; ?>" width="32" heigh="32">
