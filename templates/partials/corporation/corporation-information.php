    ...
    <span class="eve-intel-corporation-links-wrapper">
        <small>
            ...
            if((1000000 <= $data['corporationID']) && $data['corporationID'] <= 2000000) {
                ...
                ?>
                <a class="eve-intel-information-link" href="https://evemaps.dotlan.net/corp/<?php echo \str_replace(' ', '_', $data['corporationName']); ?>" target="_blank" rel="noopener noreferer">dotlan <i class="fa fa-external-link" aria-hidden="true"></i></a> | <a class="eve-intel-information-link" href="https://zkillboard.com/corporation/<?php echo $data['corporationID']; ?>/" target="_blank" rel="noopener noreferer">zkillboard <i class="fa fa-external-link" aria-hidden="true"></i></a>
                <?php
            }
            ?>
        </small>
