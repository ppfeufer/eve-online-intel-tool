...
$characterPortrait = (isset($data['characterPortrait']) && !is_null($data['characterPortrait'])) ? $data['characterPortrait'] : ImageHelper::getInstance()->getImageServerUrl('character') . $data['characterID'] . '_32.jpg';
?>
